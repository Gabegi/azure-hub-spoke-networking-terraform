# spoke-production/06-test-vm.tf
# Test VM for connectivity testing in Production spoke
...
module "test_vm" {
  ...
  custom_data = <<-EOF
    ...
    # Create test page
    echo "Production Spoke Test VM - $(hostname)" > /var/www/html/index.html
    ...
    echo ""
    echo "2. Test Development Spoke (10.1.0.0/16):"
    echo "   This should FAIL (blocked by firewall)"
    echo "   Run: curl http://<dev-vm-ip>:80 --max-time 5"
    echo ""
    echo "3. Test DNS:"
    nslookup google.com
    SCRIPT
