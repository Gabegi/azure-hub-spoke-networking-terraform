...
output "function_app_id" {
  value       = azurerm_linux_function_app.function[0].id
  description = "Full resource ID of the function app"
}

output "function_app_name" {
  value       = azurerm_linux_function_app.function[0].name
  description = "Name of the function app"
}

output "function_app_default_hostname" {
  value       = azurerm_linux_function_app.function[0].default_hostname
  description = "Default hostname of the function app"
}

output "function_app_outbound_ip_addresses" {
  value       = azurerm_linux_function_app.function[0].outbound_ip_addresses
